...
function columnTestify() {
	...
	selectActIdBtn.onclick = function () {
		...
		//清空所有ERR訊息
		document.getElementById("selectActIdErr").innerHTML = "";
		document.getElementById("selectActPodcasterErr").innerHTML = "";
		document.getElementById("selectActDateErr").innerHTML = "";
		document.getElementById("deleteActIdErr").innerHTML = "";
	...
	selectHistoryIdBtn.onclick = function () {
		...
		//按下按鈕就先清空結果&其他欄位的值
		document.getElementById("ajaxTable").value = "";
		document.getElementById("selectHistoryMemberText").value = "";
		document.getElementById("selectHistoryPodcasterText").value = "";
		document.getElementById("selectHistoryLastText").value = "";
		document.getElementById("deleteHistoryDateText").value = "";
		//清空所有ERR訊息
		document.getElementById("selectHistoryMemberErr").innerHTML = "";
		document.getElementById("selectHistoryPodcasterErr").innerHTML = "";
		document.getElementById("selectHistoryLastErr").innerHTML = "";
		document.getElementById("deleteHistoryDateErr").innerHTML = "";
		document.getElementById("selectHistoryIdErr").innerHTML = "";

		let input = document.getElementById("selectHistoryIdText").value;
		if (!input) {
			document.getElementById("selectHistoryIdErr").innerHTML = "請輸入HistoryId";
			return false;
		}
		processHistory("SelectHistoryById", input);
		return true;
	}
	...
	selectHistoryMemberBtn.onclick = function () {
		...
		//按下按鈕就先清空結果&其他欄位的值
		document.getElementById("ajaxTable").value = "";
		document.getElementById("selectHistoryIdText").value = "";
		document.getElementById("selectHistoryPodcasterText").value = "";
		document.getElementById("selectHistoryLastText").value = "";
		document.getElementById("deleteHistoryDateText").value = "";
		//清空所有ERR訊息
		...
		let input = document.getElementById("selectHistoryMemberText").value;
		if (!input) {
			document.getElementById("selectHistoryMemberErr").innerHTML = "請輸入MemberId";
			return false;
		}
		processHistory("SelectHistoryByMember", input);
		return true;
	}
	...
	selectHistoryPodcasterBtn.onclick = function () {
		...
		let input = document.getElementById("selectHistoryPodcasterText").value;
		if (!input) {
			document.getElementById("selectHistoryPodcasterErr").innerHTML = "請輸入PodcasterId";
			return false;
		}
		processHistory("SelectHistoryByPodcaster", input);
		return true;
	}
	...
	selectHistoryLastBtn.onclick = function () {
		...
		let input = document.getElementById("selectHistoryLastText").value;
		if (!input) {
			document.getElementById("selectHistoryLastErr").innerHTML = "請輸入Date";
			return false;
		}
		processHistory("SelectHistoryByLastListen", input);
		return true;
	}
	...
	deleteHistoryDateBtn.onclick = function () {
		...
		let input = document.getElementById("deleteHistoryDateText").value;
		if (!input) {
		...
		if (r == true) {
			processHistory("DeleteHistoryByDate", input);
			return true;
		} else {
	...
	selectPodcastMemberBtn.onclick = function () {
		...
		//按下按鈕就先清空結果&其他欄位的值
		document.getElementById("ajaxTable").value = "";
		document.getElementById("deletePodcastIdText").value = "";
		document.getElementById("topPodcastText").value = "";
		//清空所有ERR訊息
		document.getElementById("selectPodcastMemberErr").innerHTML = "";
		document.getElementById("deletePodcastIdErr").innerHTML = "";
		document.getElementById("topPodcastErr").innerHTML = "";


		let input = document.getElementById("selectPodcastMemberText").value;
		if (!input) {
			document.getElementById("selectPodcastMemberErr").innerHTML = "請輸入MemberId";
			return false;
		}
		processPodcast("SelectPodcastByMember", input);
		return true;
	}
	...
	deletePodcastIdBtn.onclick = function () {
		...
		//按下按鈕就先清空結果&其他欄位的值
		document.getElementById("ajaxTable").value = "";
		document.getElementById("selectPodcastMemberText").value = "";
		document.getElementById("topPodcastText").value = "";
		//清空所有ERR訊息
		document.getElementById("selectPodcastMemberErr").innerHTML = "";
		document.getElementById("deletePodcastIdErr").innerHTML = "";
		...
		let input = document.getElementById("deletePodcastIdText").value;
		if (!input) {
		...
		if (r == true) {
			processPodcast("DeletePodcastbyId", input);
			return true;
		} else {
	...
	topPodcastBtn.onclick = function () {
		...
		let input = document.getElementById("topPodcastText").value;
		if (!input) {
			document.getElementById("topPodcastErr").innerHTML = "請輸入uploadTime";
			return false;
		}
		processPodcast("TopPodcst", input);
		return true;
	}
	...
	subIncomeBtn.onclick = function () {
		//按下按鈕就先清空結果&其他欄位的值
		document.getElementById("ajaxTable").value = "";
		document.getElementById("ticketIncomeSDText").value = "";
		document.getElementById("ticketIncomeEDText").value = "";
		//清空所有ERR訊息
		document.getElementById("subIncomeErr").innerHTML = "";
		document.getElementById("ticketIncomeErr").innerHTML = "";

		let inputS = document.getElementById("subIncomeSDText").value;
		let inputE = document.getElementById("subIncomeEDText").value;
		if (!inputS) {
		...
		processIncome("SubscriptionIncome",inputS,inputE);
		return true;
	}
	...
	ticketIncomeBtn.onclick = function () {
		//按下按鈕就先清空結果&其他欄位的值
		document.getElementById("ajaxTable").value = "";
		document.getElementById("subIncomeSDText").value = "";
		document.getElementById("subIncomeEDText").value = "";
		//清空所有ERR訊息
		document.getElementById("subIncomeErr").innerHTML = "";
		document.getElementById("ticketIncomeErr").innerHTML = "";

		let inputS = document.getElementById("ticketIncomeSDText").value;
		let inputE = document.getElementById("ticketIncomeEDText").value;
		if (!inputS) {
		...
		processIncome("TicketIncome",inputS,inputE);
		return true;
	}
