								...
								<div class="card">
									...
									<div class="card-block">
										...
										<form action="<c:url value="/podcastPage"/>">
											<input type="hidden" name="fuzzyPodcasterId"
												value="${data.getMemberId()}" /> <input type="submit"
												class="btn1 first" value="前往" />
										</form>
									</div>
								</div>
							</li>
					...
					<div class="card-media">
						...
						<div class="card-media-body">
							<div class="card-media-body-top">
								...
								<!-- 依據資料庫染愛心顏色 -->
								<c:choose>
									<c:when test="${data.getLikesStatus()==1}">
								...
								<!-- 	         						</svg> -->
								<svg height="22" viewBox="0 -28 512 512" width="16"
									xmlns="http://www.w3.org/2000/svg">
	          	<path
								...
								<span class="likeNum">${data.getLikesCount()}</span>
							</div>
						</div>
						...
						<div
							...
							<c:choose>
								<c:when test="${data.getOpenPayment()==1}">
									<c:choose>
										<c:when
											test="${data.getConfirmubScription() ==2 or data.getConfirmubScription() ==1}">
										...
										<c:otherwise>
											<a id="${data.getPodcastId()}"
												href="<c:url value="/podcastPage?fuzzyPodcasterId=${data.getPodcasterId()}"/>"
