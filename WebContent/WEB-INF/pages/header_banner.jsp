			...
			<div class="container">
				...
				<div class="sm-right">
					...
					<div class="sm-social-link">
						<div
							style="display: inline-block; line-height: 20px; color: #333; z-index: -100;">
							<form action="<c:url value="FuzzySelect.controller"/>"
								method="get">
								<input id="tags" class="form-control-sm" type="text"
									name="selectCondition" /> <input class="form-control-sm"
						...
						<a class="h-twitter" href="#"><i class="fa fa-twitter"></i></a> <a
							...
							class="h-linkedin" href="#"><i class="fa fa-linkedin"></i></a>
					...
					<c:when test="${LoginOK.role==1}">
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="<c:url value='/#selectBar' />">瀏覽搜尋</a></li>
								<li>
								<li><a href="#">${LoginOK.name}</a> <!-- First Tier Drop Down -->
									<ul class="barlist">
										<li><a href="<c:url value='/update' />">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;會員資料</a></li>
										<li><a href="<c:url value='/goToLikeRecord' />">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我的最愛</a></li>
										<li><a href="<c:url value='/goToBrowsingHistory' />">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;瀏覽紀錄</a></li>
										<li><a
											href="<c:url value='/SubOrderController.controller' />">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;購買紀錄</a></li>
										<li><a href="<c:url value='/logout' />">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;登出</a></li>
									</ul></li>
								<li><a href="<c:url value='ShoppingCart' />"><i
										class="aaaa glyphicon glyphicon-shopping-cart"
										style="font-size: 20px;"><span class="img_text">${cartContent}</span></i></a>
								</li>
							</ul>
						</div>
					</c:when>
...
>>>>>>> d1d86a48b752cee2b4414e0891aa99b0274611aa
			...
			<a class="left carousel-control" href="#carousel-example-generic"
				...
				role="button" data-slide="next"> <span class="fa fa-arrow-right"
				aria-hidden="true"></span>
			</a>
		</div>
	</div>
